      ...
      <div className="absolute left-4 top-4 z-10 flex flex-col gap-4">
        {appRegistry.map((app) => (
          <button
            ...
            className="group flex w-20 flex-col items-center gap-1 rounded-lg p-2 text-center transition-colors hover:bg-white/5 focus-visible:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
          ...
          >
            ...
            <span className="text-[11px] leading-tight text-[var(--color-text)] drop-shadow">
              {app.name}
            </span>
          </button>
        ))}
